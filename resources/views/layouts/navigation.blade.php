<aside class="w-64 bg-[#12141c] flex flex-col border-r border-gray-800 transition-all duration-300">
    ...
    <nav class="flex-1 overflow-y-auto py-6 px-4 space-y-2">
        ...
        @elseif(Auth::user()->role === 'admin_jaringan')
            ...
            <a href="{{ route('adminjaringan.network.scan') }}" class="flex items-center px-4 py-3 {{ request()->routeIs('adminjaringan.network.scan') ? 'bg-gradient-to-r from-cyan-600 to-blue-600 text-white shadow-[0_0_15px_rgba(34,211,238,0.4)]' : 'text-gray-400 hover:bg-[#1a1c26] hover:text-white' }} rounded-xl transition-all">
                ...
                <span class="font-semibold text-sm">Scan Jaringan</span>
            </a>
